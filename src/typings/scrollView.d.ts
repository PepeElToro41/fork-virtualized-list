...
declare class ScrollViewComponent extends React.Component<ScrollViewProps> {
	public render(): React.Element | undefined; // OverHash deviation: implement method for Roact
}
...
export class ScrollView extends ScrollViewBase {
	...
	public render(): React.Element | undefined; // OverHash deviation: work with roact typings
}
